...
export default function Landing() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-primary-dark via-primary to-[#34913a]">
      ...
      <div className="flex-1 flex items-center justify-center px-5 sm:px-8">
        <div className="max-w-5xl mx-auto w-full flex flex-col lg:flex-row items-center gap-10 lg:gap-16 py-12 lg:py-0">
          <div className="flex-1 text-center lg:text-left">
            <p className="text-xs uppercase tracking-[0.2em] text-white/50 font-medium mb-3">Digital Healthcare Platform</p>
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white leading-[1.15] tracking-tight">
              Healthcare,<br />accessible anywhere.
            </h1>
            <p className="mt-3 text-sm text-white/60 leading-relaxed max-w-sm mx-auto lg:mx-0">
            ...
            <div className="mt-5 flex items-center gap-3 justify-center lg:justify-start">
              <Link to="/signup" className="inline-flex items-center gap-1.5 bg-white text-primary-dark font-semibold px-5 py-2.5 rounded-md text-sm hover:bg-white/90 transition">
                Get Started <ArrowRight className="w-4 h-4" />
              </Link>
              <span className="text-xs text-white/40 font-medium">In development</span>
            </div>
          </div>
      ...
      {/* Footer */}
      <footer className="px-5 sm:px-8 py-4 max-w-6xl mx-auto w-full flex items-center justify-between text-xs text-white/30">
